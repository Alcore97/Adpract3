...
public class ClientServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            java.util.List<java.lang.Object> ll  = listImages();
            out.println("Aquesta es la meva llista " + ll);
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    private int modifyImage(org.me.image.Image imatge) {
    ...
    private int registerImage(org.me.image.Image imatge) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        org.me.image.ImageWS port = service.getImageWSPort();
    ...
    private java.util.List<java.lang.Object> searchByTitle(java.lang.String titol) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        org.me.image.ImageWS port = service.getImageWSPort();
    ...
    private java.util.List<java.lang.Object> searchbyAuthor(java.lang.String autor) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        org.me.image.ImageWS port = service.getImageWSPort();
    ...
    private java.util.List<java.lang.Object> searchbyCreaDate(java.lang.String datacreacio) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        org.me.image.ImageWS port = service.getImageWSPort();
    ...
    private java.util.List<java.lang.Object> searchbyKeywords(java.lang.String paraulaclau) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        org.me.image.ImageWS port = service.getImageWSPort();
